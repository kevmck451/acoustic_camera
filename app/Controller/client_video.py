...
class VideoClient:
    def __init__(self, host='10.0.0.1', port=56565):
        self.host = host
        self.port = port
        self.sock = None
        ...
        while True:
            try:
                ...
                while True:
                    ...
                    # Process data if end of frame is detected
                    # Assuming is_end_of_frame and process_video_data are defined
...
#                 # Process received data if it's the end of a frame
#                 if self.is_end_of_frame(data):
#                     self._current_frame = self.process_video_data(data)
#                     data = b''  # Reset buffer for next frame
#
#
#
