...
# Settings Window
class Overlay_Threshold_Window(ctk.CTk):
    def __init__(self, event_handler):
        ...
        # Main Setup ------------------------------------------------------------
        self.title(configuration.overlay_threshold_window_title)
        ...
        self.Main_Frame = Threshold_Frame(self, event_handler)
...
class Threshold_Frame(ctk.CTkFrame):
    def __init__(self, parent, event_handler):
        ...
        self.threshold_frame(main_frame)
